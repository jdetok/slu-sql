...
AND a.SGBSTDN_PIDM = (select spriden_pidm from spriden where spriden_change_ind is null and spriden_id = '001498867')
-- END
;
SELECT RORALGS_AMT
FROM SARADAP a
...
AND a.SARADAP_PIDM = (select spriden_pidm from spriden where spriden_change_ind is null and spriden_id = '001498867')