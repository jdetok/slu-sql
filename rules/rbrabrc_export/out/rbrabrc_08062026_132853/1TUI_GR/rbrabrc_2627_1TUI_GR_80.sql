...
AND CASE -- cohort code
    WHEN SARCHRT_CHRT_CODE = (ROBINST_AIDY_END_YEAR || 'PT') THEN (ROBINST_AIDY_END_YEAR || 'PT')
    WHEN SARCHRT_CHRT_CODE = ((ROBINST_AIDY_END_YEAR + 1) || 'PT') THEN ((ROBINST_AIDY_END_YEAR + 1) || 'PT')
    WHEN SARCHRT_CHRT_CODE = ((ROBINST_AIDY_END_YEAR + 2) || 'PT') THEN ((ROBINST_AIDY_END_YEAR + 2) || 'PT')
END = RORALGS_KEY_11		
