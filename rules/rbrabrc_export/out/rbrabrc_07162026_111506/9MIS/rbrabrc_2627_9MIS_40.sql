...
;
select * from sgbstdn where sgbstdn_pidm = (select spriden_pidm from spriden where spriden_change_ind is null and spriden_id = '001497104');
select * from saradap where saradap_pidm = (select spriden_pidm from spriden where spriden_change_ind is null and spriden_id = '001497104');

select * from sgrchrt where sgrchrt_pidm = (select spriden_pidm from spriden where spriden_change_ind is null and spriden_id = '001497104');