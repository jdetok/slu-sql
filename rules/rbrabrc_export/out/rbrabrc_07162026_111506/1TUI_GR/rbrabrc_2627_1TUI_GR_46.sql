--GRAD MS HEALTH ADMIN HADM14 NO SGASTDN
SELECT (RORALGS_AMT * 6)
FROM SARADAP a, SARAPPD b, RORALGS, STVAPDC, ROBINST
...
AND CASE -- college code
    WHEN a.SARADAP_COLL_CODE_1 = 'PH' THEN 'PH'
END = RORALGS_KEY_7

AND CASE -- major/program code
    WHEN a.SARADAP_PROGRAM_1 = 'HADM14' THEN 'HADM14'
END = RORALGS_KEY_9	
