...
AND X.SGBSTDN_PIDM = (select spriden_pidm from spriden where spriden_change_ind is null and spriden_id = '000426513')
...
select *
from sgrsatt
where sgrsatt_pidm = (select spriden_pidm from spriden where spriden_change_ind is null and spriden_id = '000426513');