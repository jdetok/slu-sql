...
END = RORALGS_KEY_5
AND CASE 
	WHEN a.SARADAP_FULL_PART_IND IS NULL or a.SARADAP_FULL_PART_IND = 'F' then 'FT'
	WHEN a.SARADAP_FULL_PART_IND = 'P' then 'PT'
END = RORALGS_KEY_12
-- sgbstdn term
...
;
select sgbstdn_full_part_ind from sgbstdn where sgbstdn_levl_code = 'PL';