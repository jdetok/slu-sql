...
SELECT RORALGS_AMT
FROM SGBSTDN X, RORALGS, SGRCHRT b, ROBINST
...
AND CASE -- cohort code
    WHEN SGRCHRT_CHRT_CODE = (ROBINST_AIDY_END_YEAR || 'PT') THEN (ROBINST_AIDY_END_YEAR || 'PT')
   WHEN SGRCHRT_CHRT_CODE = ((ROBINST_AIDY_END_YEAR + 1) || 'PT') THEN ((ROBINST_AIDY_END_YEAR + 1) || 'PT')                 
   WHEN SGRCHRT_CHRT_CODE = ((ROBINST_AIDY_END_YEAR + 2) || 'PT') THEN ((ROBINST_AIDY_END_YEAR + 2) || 'PT')
  END = RORALGS_KEY_11		
