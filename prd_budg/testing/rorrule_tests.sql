-- madrid PB rorrule
-- first find madrid deposited (STVAPDC_STDN_ACC_IND = 'Y')
-- then find madrid admit   STVAPDC_INST_ACC_IND = 'Y' AND STVAPDC_SIGNF_IND = 'Y' STVAPDC_STDN_ACC_IND <> 'Y'
SELECT count(distinct a.RORSTAT_PIDM)
FROM RORSTAT a
